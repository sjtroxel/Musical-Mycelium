...
const GRAPH: RenderGraph = {
  ...
  edges: [
    { from: "Q2", to: "Q1", kind: "claimed", predicate: "influenced_by", order: 1, verification: "HAND" },
    { from: "Q3", to: "Q2", kind: "context", predicate: "influenced_by", order: null, verification: null },
  ],
  claimed: 1,
  context: 1,
  opened: 0,
