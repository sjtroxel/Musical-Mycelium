...
resource "aws_lambda_function" "app" {
  ...
  environment {
    variables = {
      # The image already defaults to bedrock; stating it here means the deployed configuration is
      # readable in the console without going and reading a Dockerfile.
