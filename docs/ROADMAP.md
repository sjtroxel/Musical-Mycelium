...
| **7.5** `portfolio-and-writeup` **COMPLETE 2026-09-17** | **v1.0** | ~~v0.7.1 (pinned, unchanged)~~ **v0.10.0, inherited from 7.6** | The published eval report, the trend view, the writeup, the README and the recruiter path; the Terraform round-trip and a verified bill | No architecture change |
...
| 7.5 | **written 2026-09-08**, at the moment the phase was conceived; **amended 2026-09-11** (writeup is the LinkedIn post; pin moves in 7.6) | written 2026-09-09; **ALL STEPS DONE, phase CLOSED 2026-09-17**; step 6's verdicts are `phase-7.5-DOD-AUDIT.md` |
